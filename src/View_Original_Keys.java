...
public class View_Original_Keys extends JFrame implements ActionListener
{
...
setTitle("Origianl Keys :: Authentication and Key Agreement Based on Anonymous Identity for Peer-to-Peer Cloud");
c= getContentPane();
c.setLayout (null);
...
//	 heading.addElement("SL NO");
		...
		heading.addElement("Secret Key");
			  ...
			  Dbcon db = new Dbcon();
	             ...
	             String query = "SELECT fname,sk From Backup";
