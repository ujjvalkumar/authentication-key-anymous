...
public class ViewBlocked extends JFrame implements ActionListener
{
...
setTitle("Blocked Users :: Authentication and Key Agreement Based on Anonymous Identity for Peer-to-Peer Cloud");
c= getContentPane();
c.setLayout (null);
