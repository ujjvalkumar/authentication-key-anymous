...
public class ViewKDC extends JFrame implements ActionListener
{
...
setTitle("View KDC ::Authentication and Key Agreement Based on Anonymous Identity for Peer-to-Peer Cloud");
c= getContentPane();
c.setLayout (null);
